...
import barqsoft.footballscores.widget.ProviderWidgetScores;
...
public class MyFetchService extends IntentService
{
    ...
    private void updateWidgets() {
        Intent dataUpdatedIntent = new Intent(ProviderWidgetScores.ACTION_DATA_UPDATED).setPackage(getPackageName());

...
public class Utilities
{
    ...
    public static Intent createShareScoresIntent(@NonNull String ShareText, @NonNull String footballScoresHashtag) {
        Intent shareIntent = new Intent(Intent.ACTION_SEND);
        shareIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
        shareIntent.setType("text/plain");
        shareIntent.putExtra(Intent.EXTRA_TEXT, ShareText + footballScoresHashtag);
        return shareIntent;
    }

    public static String getLeague(int league_num, @NonNull Context context)
    {
        switch (league_num)
        {
            ...
            default                 : return context.getString(R.string.uknown_league);
        }
    }
    public static String getMatchDay(int match_day,int league_num, @NonNull Context context)
    {

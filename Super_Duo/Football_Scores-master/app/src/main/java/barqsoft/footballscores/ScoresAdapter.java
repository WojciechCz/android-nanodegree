...
public class ScoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            match_day.setText(Utilities.getMatchDay(cursor.getInt(COL_MATCHDAY), cursor.getInt(COL_LEAGUE), context));
            ...
            share_button.setOnClickListener(new View.OnClickListener() {
                ...
                {
                    //add Share Action
                    String message = mHolder.home_name.getText() + " " + mHolder.score.getText() + " " + mHolder.away_name.getText() + " ";
                    context.startActivity(Utilities.createShareScoresIntent(message, ScoresAdapter.this.FOOTBALL_SCORES_HASHTAG));
                }
            });
        }
        else

 ...
 */
public abstract class AdapterRecyclerViewCursor<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{

    private static final String LOG_TAG = AdapterRecyclerViewCursor.class.getSimpleName();
    ...
    public AdapterRecyclerViewCursor(Context context, Cursor cursor){
        mContext = context;
        mCursor = cursor;
